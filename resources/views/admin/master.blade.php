                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="pcoded-hasmenu">
                                <a href="javascript:void(0)">
                                    ...
                                    <span class="pcoded-mtext" data-i18n="nav.basic-components.main">List Table</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                                    ...
                                    <li class=" ">
                                        <a href="{{route('brand.list')}}">
                                            ...
                                            <span class="pcoded-mtext"
                                                  data-i18n="nav.basic-components.alert">List Brand</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                    <li class=" ">
                                        <a href="{{route('category.list')}}">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs"> List Category </span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                    <li class=" ">
                                        <a href="{{route('product.list')}}">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext"
                                                  data-i18n="nav.basic-components.alert">List Product</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                </ul>
