                ...
                <div class="signup-card card-block auth-body mr-auto ml-auto">
                    <form action="{{route('users.store')}}" method="post" class="md-float-material">
                        ...
                        <div class="auth-box">
                            ...
                            <div class="mt-3">
                                <input name="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Choose Password">
                                @error('password') <p class="text-danger">{{$message}}</p> @enderror
                                <span class="md-line"></span>
                            </div>
{{--                            <div class="mt-3">--}}
{{--                                <input name="confirm-password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Confirm Password">--}}
{{--                                @error('password') <p class="text-danger">{{$message}}</p> @enderror--}}
{{--                                <span class="md-line"></span>--}}
{{--                            </div>--}}
